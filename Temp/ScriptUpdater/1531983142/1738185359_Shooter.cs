...
public class Shooter : MonoBehaviour
{
    ...
    public float launchSpeed = 100f; // Adjust force for better effect
    ...
    private void Shoot()
    {
        ...
        if (rb != null)
        {
            ...
            rb.linearVelocity = (shootDirection * 100) + playerRigidbody.linearVelocity; // Shoot with a specific speed
        }
        else
        {
